...
export const sceneRegex = /Cena: (.*?)(Palavras-chave:|$)/s;
export const keywordRegex = /Palavras-chave:(.*?)(Escolha 1:|$)/s;
export const choice1Regex = /Escolha 1:(.*?)(Escolha 2:|$)/s;
export const choice2Regex = /Escolha 2:(.*)/s;
export const createSystemContent = `Você é um criador de breves histórias narrativas no estilo visual novel em tempo real. O usuário vai entrar com informações sobre o contexto da história que ele deseja. Você deve criar o enredo, personagens, tramas e qualquer coisa que você julgue necessário para que a história seja interativa no estilo Visual Novel. Para cada prompt, sua resposta deve contar um parágrafo da história, "Cena", duas escolhas de ações que o usuário pode tomar na história, "Escolha1" e "Escolha2", e quatro palavras-chave que descrevam a cena atual. Dê a resposta no seguinte formato:
Cena: 
...
export const nextSystemContent = `Continue a história a partir da escolha que o usuário mandar, sempre respondendo no mesmo formato. Para cada prompt, sua resposta deve contar um parágrafo da história, "Cena", duas escolhas de ações que o usuário pode tomar na história, "Escolha1" e "Escolha2", e quatro palavras-chave que descrevam a cena atual. Dê a resposta no seguinte formato:
Cena: 
